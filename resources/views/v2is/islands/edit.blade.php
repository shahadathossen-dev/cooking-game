@extends('layouts.frontend', ['activePage' => 'island-management', 'titlePage' => __('Island Management')])
...
<main class="content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <form method="post" action="{{ route('v1is.islands.update', $island) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('put')

                <div class="card ">
                    <div class="card-header card-header-primary content-header">
                        <h4 class="card-title">{{ __('Edit Island') }}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('is_name') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('is_name') ? ' is-invalid' : '' }}" name="is_name" id="input-is_name" type="text" placeholder="{{ __('Map Name') }}" value="{{ $island->is_name }}" required="true" aria-required="true"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('is_zone1') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('is_zone1') ? ' is-invalid' : '' }}" name="is_zone1" id="input-is_zone1" type="text" placeholder="{{ __('Zone 1 Name') }}" value="{{ $island->is_zone1 }}" required="true" aria-required="true"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('is_zone2') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('is_zone2') ? ' is-invalid' : '' }}" name="is_zone2" id="input-is_zone2" type="text" placeholder="{{ __('Zone 2 Name') }}" value="{{ $island->is_zone2 }}" required="true" aria-required="true"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('is_zone3') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('is_zone3') ? ' is-invalid' : '' }}" name="is_zone3" id="input-is_zone3" type="text" placeholder="{{ __('Zone 3 Name') }}" value="{{ $island->is_zone3 }}" required="true" aria-required="true"/>
