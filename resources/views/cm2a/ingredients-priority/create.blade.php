...
<main class="content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('cm2a.ingredient-priority.store') }}" autocomplete="off" class="form-horizontal">
                    @csrf
                    @method('post')
                    ...
                    <div class="card ">
                        <div class="card-header card-header-primary content-header">
                            ...
                            <a href="{{ route('cm2a.ingredient-priority.index') }}" class="btn btn-sm btn-primary text-white">{{ __('Back to list') }}</a>
                        </div>
                        <div class="card-body ">
                            <div class="container">
                                <div class="row">
                                    <label for="ing" class="col-sm-2 col-form-label">{{ __('1st Ingredient') }}</label>
                                    <div class="col-sm-7">
...
const app = new Vue({
    ...
    methods:{
        getIngredients(){
            axios.get('{{route("cm2a.ingredients.list")}}')
                .then(res=>{
