...
@section('content')
    <main class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('dungeon-cleaner.tile-spawns.update', $tileSpawn) }}" autocomplete="off"
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('Name') }}"
                                                            value="{{ $tileSpawn->tile_spawn_name }}" required="true"
                                                            aria-required="true" />
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('Min') }}"
                                                            value="{{ $tileSpawn->tile_spawn_min }}" required="true"
                                                            aria-required="true" />
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('Max') }}"
                                                            value="{{ $tileSpawn->tile_spawn_max }}" required="true"
                                                            aria-required="true" />
