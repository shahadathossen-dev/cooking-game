...
@section('content')
    <main class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('dungeon-cleaner.tile-spawns.update', $dangerMeter) }}" autocomplete="off"
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('Name') }}"
                                                            value="{{ $dangerMeter->tile_spawn_name }}" required="true"
                                                            aria-required="true" />
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('Min') }}"
                                                            value="{{ $dangerMeter->tile_spawn_min }}" required="true"
                                                            aria-required="true" />
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('Max') }}"
                                                            value="{{ $dangerMeter->tile_spawn_max }}" required="true"
                                                            aria-required="true" />
