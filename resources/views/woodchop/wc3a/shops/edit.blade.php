...
@section('content')
    <main class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('woodchop.wc3a.shops.update', $shop) }}" autocomplete="off"
                                                ...
                                                <div class="col-sm-7">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ $shop->shop_name }}" required="true"
                                                            aria-required="true" />
