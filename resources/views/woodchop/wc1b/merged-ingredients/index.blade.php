        ...
        <v-col md="10" sm="12">
            <v-card>
                <div class="card-header card-header-primary content-header">
                    ...
                    <a href="{{ route('cm1b.merged-ingredients.create') }}" class="btn btn-sm btn-primary text-white">{{ __('Add ingredient') }}</a>
                </div>
                <div class="card-body">
                    @if (session('status'))
                    <div class="row">
                        ...
                        <table class="table table-stripped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('cm1b.merged-ingredients.destroy', $ingredient) }}" method="post">
                                            @csrf

                                            <a rel="tooltip" class="btn btn-success btn-sm" href="{{ route('cm1b.merged-ingredients.edit', $ingredient) }}" data-original-title="" title="">
