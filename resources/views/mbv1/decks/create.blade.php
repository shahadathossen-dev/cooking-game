@extends('layouts.frontend', ['activePage' => 'decks-management', 'titlePage' => __('Deck Management')])
...
<main class="content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('mbv1.decks.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('post')

                    <div class="card ">
                        <div class="card-header card-header-primary content-header">
                            <h4 class="card-title">{{ __('Add Deck') }}</h4>
                            <a href="{{ route('mbv1.decks.index') }}" class="btn btn-sm btn-primary text-white">{{ __('Back to list') }}</a>
                        </div>
                        <div class="card-body ">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('deck_name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_name') ? ' is-invalid' : '' }}" name="deck_name" id="input-deck_name" type="text" placeholder="{{ __('Map Name') }}" value="{{ old('deck_name') }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('deck_description') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_description') ? ' is-invalid' : '' }}" name="deck_description" id="input-deck_description" type="text" placeholder="{{ __('Deck Description') }}" value="{{ old('deck_description') }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('deck_type') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_type') ? ' is-invalid' : '' }}" name="deck_type" id="input-deck_type" type="text" placeholder="{{ __('Deck Type') }}" value="{{ old('deck_type') }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group{{ $errors->has('deck_power') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_power') ? ' is-invalid' : '' }}" name="deck_power" id="input-deck_power" type="number" placeholder="{{ __('10') }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group{{ $errors->has('deck_health') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_health') ? ' is-invalid' : '' }}" name="deck_health" id="input-deck_health" type="number" placeholder="{{ __('10') }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group{{ $errors->has('deck_gold') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_gold') ? ' is-invalid' : '' }}" name="deck_gold" id="input-deck_gold" type="number" placeholder="{{ __('10') }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('deck_special') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('deck_special') ? ' is-invalid' : '' }}" name="deck_special" id="input-deck_special" type="text" placeholder="{{ __('Deck Special') }}" value="{{ old('deck_special') }}" required="true" aria-required="true"/>
