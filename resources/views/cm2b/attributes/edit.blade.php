...
@section('content')
<main class="content">
    <form method="post" action="{{ route('cm2b.attributes.update', $attribute) }}" autocomplete="off" class="form-horizontal container">
        @csrf
        @method('put')
        ...
        <div class="card">
            <div class="card-header card-header-primary content-header">
                ...
                <a href="{{ route('cm2b.attributes.index') }}" class="btn btn-sm btn-primary text-white">{{ __('Back to list') }}</a>
            </div>
            <div class="card-body ">
                <div class="container">
                    <div class="row">
