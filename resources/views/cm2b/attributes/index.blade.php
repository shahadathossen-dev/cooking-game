        ...
        <v-col md="10" sm="12">
            <v-card>
                <div class="card-header card-header-primary content-header">
                    ...
                    <a href="{{ route('cm2b.attributes.edit', $attribute) }}" class="btn btn-sm btn-primary text-white">{{ __('Edit Attribute') }}</a>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                {{-- <div class="td-actions text-right">
                                    <form action="{{ route('cm2b.attributes.destroy', $attribute) }}" method="post">
                                        @csrf

                                        <a rel="tooltip" class="btn btn-success btn-sm" href="{{ route('cm2b.attributes.edit', $attribute) }}" data-original-title="" title="">
