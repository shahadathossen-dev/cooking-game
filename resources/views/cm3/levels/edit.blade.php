                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('lvl_score') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('lvl_score') ? ' is-invalid' : '' }}" name="lvl_score" id="input-lvl_score" type="number" value="{{ $level->lvl_score }}" placeholder="{{ __('1.00') }}" step="0.01" required />
