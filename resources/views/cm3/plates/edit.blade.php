...
<main class="content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <form method="post" action="{{ route('cm3.plates.update', $plate) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('put')

                <div class="card ">
                    <div class="card-header card-header-primary content-header">
                        <h4 class="card-title">{{ __('Edit Plate') }}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('plate_color') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('plate_color') ? ' is-invalid' : '' }}" name="plate_color" id="input-plate_color" type="text" placeholder="{{ __('Plate Color') }}" value="{{ $plate->plate_color }}" required="true" aria-required="true"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('plate_money') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('plate_money') ? ' is-invalid' : '' }}" name="plate_money" id="input-plate_money" value="{{ $plate->plate_money }}" min="1" type="number" placeholder="{{ __('1') }}" required />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('plate_happy') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('plate_happy') ? ' is-invalid' : '' }}" name="plate_happy" id="input-plate_happy" min="1" value="{{ $plate->plate_happy }}" type="number" placeholder="{{ __('10') }}" required />
