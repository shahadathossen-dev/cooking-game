...
use App\Models\CM2B\MergedIngredient;
use App\Http\Controllers\Controller;
use App\Models\CM2B\IngredientPriority;
use App\Http\Requests\CM2B\IngredientPriorityRequest;
...
class IngredientPriorityController extends Controller
{
    ...
    {
        return view('cm2b.ingredients-priority.index', ['ingredients' => $ingredient->all()]);
    }
    ...
    public function create()
    {
        ...
        return view('cm2b.ingredients-priority.create', ['ingredients_list' => $ingredients_list]);
    }
    ...
    public function store(IngredientPriorityRequest $request)
    {
        ...
        return redirect()->route('cm2b.ingredient-priority.index')->withStatus(__('IngredientPriority created successfully.'));
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\Models\CM2B\IngredientPriority  $ingredient
     * @return \Illuminate\Http\Response
     */
    public function show(IngredientPriority $ingredient)
    {
        return view('cm2b.ingredients-priority.show', compact('ingredient'));
    }
    ...
    public function edit(IngredientPriority $ingredient)
    {
        ...
        return view('cm2b.ingredients-priority.edit', compact('ingredient', 'ingredients_list'));
    }
    ...
    public function update(IngredientPriorityRequest $request, IngredientPriority $ingredient)
    {
        ...
        return redirect()->route('cm2b.ingredient-priority.index')->withStatus(__('IngredientPriority successfully updated.'));
    }
    ...
    public function destroy(IngredientPriority $ingredient)
    {
        ...
        return redirect()->route('cm2b.ingredient-priority.index')->withStatus(__('IngredientPriority successfully deleted.'));
    }
}
