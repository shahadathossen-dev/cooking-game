...
use App\Models\WC1B\Ingredient;
use App\Http\Controllers\Controller;
use App\Models\WC1B\MergedIngredient;
use App\Http\Requests\WC1B\MergedIngredientRequest;
...
class MergedIngredientController extends Controller
{
    ...
    {
        return view('cm1b.merged-ingredients.index', ['ingredients' => $ingredient->all()]);
    }
    ...
    public function create()
    {
        ...
        return view('cm1b.merged-ingredients.create', ['ingredients_list' => $ingredients_list]);
    }
    ...
    public function store(MergedIngredientRequest $request)
    {
        ...
        return redirect()->route('cm1b.merged-ingredients.index')->withStatus(__('MergedIngredient created successfully.'));
    }
    ...
    {
        return view('cm1b.merged-ingredients.show', compact('ingredient'));
    }
    ...
    public function edit(MergedIngredient $ingredient)
    {
        ...
        return view('cm1b.merged-ingredients.edit', compact('ingredient', 'ingredients_list'));
    }
    ...
    public function update(MergedIngredientRequest $request, MergedIngredient $ingredient)
    {
        ...
        return redirect()->route('cm1b.merged-ingredients.index')->withStatus(__('MergedIngredient successfully updated.'));
    }
    ...
    public function destroy(MergedIngredient $ingredient)
    {
        ...
        return redirect()->route('cm1b.merged-ingredients.index')->withStatus(__('MergedIngredient successfully deleted.'));
    }
}
