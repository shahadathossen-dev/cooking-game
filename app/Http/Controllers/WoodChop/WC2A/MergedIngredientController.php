...
use App\Models\WC2A\Ingredient;
use App\Http\Controllers\Controller;
use App\Models\WC2A\MergedIngredient;
use App\Http\Requests\WC2A\MergedIngredientRequest;
...
class MergedIngredientController extends Controller
{
    ...
    {
        return view('cm2a.merged-ingredients.index', ['ingredients' => $ingredient->all()]);
    }
    ...
    public function create()
    {
        ...
        return view('cm2a.merged-ingredients.create', ['ingredients_list' => $ingredients_list]);
    }
    ...
    public function store(MergedIngredientRequest $request)
    {
        ...
        return redirect()->route('cm2a.merged-ingredients.index')->withStatus(__('MergedIngredient created successfully.'));
    }
    ...
    {
        return view('cm2a.merged-ingredients.show', compact('ingredient'));
    }
    ...
    public function edit(MergedIngredient $ingredient)
    {
        ...
        return view('cm2a.merged-ingredients.edit', compact('ingredient', 'ingredients_list'));
    }
    ...
    public function destroy(MergedIngredient $ingredient)
    {
        ...
        return redirect()->route('cm2a.merged-ingredients.index')->withStatus(__('MergedIngredient successfully deleted.'));
    }
}
